...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"ip_dyn=yes\0" \
    "uboot=tftpboot 0x12000000 u-boot.imx.btds; mmc write 0x12000000 2 800\0" \
    "suboot=loady 0x12000000 115200; mmc write 0x12000000 2 800\0" \
    "sfwrite=sf probe; sf erase 0 0x80000; tftpboot 0x12000000 u-boot.imx.btds; sf write 0x12000000 0x400 ${filesize}\0" \
    "kernel=tftpboot 0x10000000 uImage.imx6.btds; nand erase 0x0 0x800000; nand write 0x10000000 0x0 0x800000\0" \
    "dtb=tftpboot 0x12000000 imx6q.btds.dtb; mmc write 0x12000000 3A00 400\0" \
    "ramdisk=tftpboot 0x1a000000 ramdisk.imx6.btds-1.2-32M.gz; nand erase 0x800000 0x1000000; nand write 0x1a000000 0x800000 0x1000000\0" \
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"upkernel=tftpboot 0x10000000 uImage.imx6.btds; tftpboot 0x1a000000 ramdisk.imx6-1.0-32M.gz; bootm 0x10000000\0 " \
	"nandboot=nand read 0x10000000 0x0 0x00800000; nand read 0x1a000000 0x00800000 0x00800000; bootm 0x10000000\0 " \
    "uboot=tftpboot 0x10000000 u-boot.imx.btds; sf probe; sf erase 0x0 0xC0000; sf write 0x10000000 0x400 0xC0000\0" \
    "kernel=tftpboot 0x10000000 uImage.imx6.btds; nand erase 0x0 0x800000; nand write 0x10000000 0x0 0x800000\0" \
